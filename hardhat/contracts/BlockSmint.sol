...
contract BlockSmint is ERC721Staked {
  string public metadataAddress;

  function initialize(string memory _metadataAddress) public initializer {
    __ERC721Staked_init("BlockForge","sBLKF");
  ...
  function setMetadataAddress(string memory _metadataAddress) external onlyOwner {
    metadataAddress = _metadataAddress;
  }
